...
def process_file(filename):
  ...
  result_after_regex = postprocessor.process_with_regex(ocr_output)
  ...
  if flag_pswbn in ("split","join"):
      result_after_pfe = process_format_error.correct_split_word_by_newline(result_after_regex, flag_pswbn, language_model)
  ...
  result = postprocessor.correct_errors_process(text_to_procces, language_model)

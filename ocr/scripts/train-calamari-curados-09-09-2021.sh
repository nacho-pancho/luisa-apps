...
calamari-train --dataset HDF5 \
	...
	--files      /datos/luisa/ocr/data/luisa-curados/half8/calamari-train.h5 \
	--validation /datos/luisa/ocr/data/luisa-curados/half8/calamari-val.h5 \
	--weights    /datos/luisa/ocr/models/2021-07-25-cur_8bit_half/best.ckpt.h5 \
       	$* ## esto es porque se cortó sin querer en el medio
